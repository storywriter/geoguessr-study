...
地図上の位置と結び付けて覚える、GeoGuessrの自主学習資料です。

| 地図帳 | 内容 |
|---|---|
| [第二弾：ヨーロッパ周辺の特徴的な文字形](topics/european-letterforms/README.md) | 56の国・統計地域、232項目。46ページの地図帳、文字比較、地域言語のCSV |
| [第一弾：ヒジャブの出現率](#ヒジャブの出現率) | 98の国・統計地域、156項目。10ページの地図帳とCSV |

## ヒジャブの出現率

第一弾は98の国・統計地域について、156の学習項目を収録しています。
